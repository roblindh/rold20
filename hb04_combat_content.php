...
<p>
    Furthermore, whenever a melee attack action is performed,
...
<p>
    ...
    If no action is spent controlling the vehicle, it tends to continue moving in roughly
    the same direction and at the same speed as previous round(s).
    The DM should try to determine the chance of a crash or similar mishap during each round that a vehicle moves without being controlled.<br/>
    Passengers that are not busy as crew can perform actions as normal, including manning siege weapons,
    attacking with ranged weapons, casting spells, etc.
    The size and nature of the vehicle may of course limit or affect movement actions available to passengers.
</p>
<p>
    The following special rules apply to vehicle movement and combat:
</p>
<ul>
    ...
    <li>Small or cramped vehicles make it harder to wield two-handed or double weapons, giving the attacker at least a -2 attack penalty.</li>
    <li>Attacks of opportunity provoked by movement of the vehicle can target either the vehicle or passengers that are within reach.</li>
</ul>
