...
function chargen_page_campaign() {
    ...
    echo '<br/><table><thead><tr><th>Campaign</th>' .
        '<th style="text-align:center">XP</th><th>Optional Rules</th></tr></thead><tbody>';
...
function chargen_page_ability() {
    ...
    if ($_APP['abilitygen'][$genmethod]['Generation'][0] == 'B') {
        ...
        echo '<tr><td>Point Pool:</td><td><input type="text" id="PointPool" value="' .
...
function chargen_page_race() {
    ...
    echo '<table><thead><tr><th>Race</th>' .
        '<th>Ability Mods</th><th style="text-align:center">CL</th></tr></thead><tbody>';
    foreach ($_APP['creatures'] as $iCreature) {
        if ($iCreature['BaseRL'] + $iCreature['CLModifier'] <= $level_limit &&
            ...
            echo '<td style="text-align:center" id="RaceLvl' . $iCreature['ID'] . '">' .
                ($iCreature['BaseRL'] + $iCreature['CLModifier']) . '</td></tr>';
        }
    }
    echo '</tbody></table><br/>';

    echo '<table><thead><tr><th>Template</th>' .
        '<th>Ability Mods</th><th style="text-align:center">CL</th></tr></thead><tbody>';
    foreach ($_APP['templates'] as $iTemplate) {
        if ($iTemplate['RLModifier'] + $iTemplate['CLModifier'] <= $level_limit &&
            ...
            echo '<td style="text-align:center" id="TemplateLvl' . $iTemplate['ID'] . '">' .
...
function chargen_page_backgnd() {
    ...
    echo '<table><thead><tr><th>Culture</th><th>Background Class</th></tr></thead><tbody>';
...
function chargen_page_class() {
    ...
    echo '<table><thead><tr><th style="text-align:center">Lvl</th><th>Class</th></tr></thead><tbody>';
...
function chargen_page_improv() {
    ...
    foreach ($_APP['improvementtraits'] as $iImprovement) {
        ...
        echo '<td id="IPCost' . $iImprovement['ID'] . '" style="text-align:center">' . $iImprovement['IPCost'] . '</td>';
    ...
    echo '<table><thead><tr>';
    echo '<th>Skill Improvement</th><th style="text-align:center">Cost</th><th style="text-align:center">Bonus</th><th>Access</th>';
    echo '</tr></thead><tbody>';
    ...
    for ($i = 1; isset($_POST['ImprSkill' . $i]) || $add_skill; $i++) {
        ...
        echo '<td style="text-align:center"></td><td style="text-align:center"></td><td></td></tr>';
    }
    echo '</tbody></table><br/>';
...
function chargen_page_skill() {
    ...
    echo '<br/><table style="font-size:1em; border-spacing:2px;"><tr valign="top"><tbody>';
    echo '<td><table><thead><tr>';
