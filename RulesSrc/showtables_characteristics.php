...
function show_sizecategories() {
    ...
    <p>
        ...
        In such a system, minor nobles typically include the ranks baronet, baron, and viscount, while major nobles include count, marquis, and duke (see below for more examples).
...
function show_speffects() {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo "<td align=\"center\">" . $row['Expenses'] . "</td>";
        echo "</tr>";
    }
    ?>
    </table>
    ...
    <p>
        ...
        80% of this money can be regained by selling resources and holdings, dropping back to the previous class in the process.<br/>
        Expenses: Typical daily expenses for food, lodging, and other common consumables in this wealth bracket.
        This is also what you have to pay if you want to temporarily live above your WC or pretend to be wealthier than you are.
    </p>
        <?php
        mysqli_close($dbc);
    }
