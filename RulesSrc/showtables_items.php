...
function show_itemcurses() {
    ?>
    <p>
        The following table can provide ideas for item drawbacks:
    </p><br />

    <table class="table">
        <caption align="bottom">Common Drawbacks</caption>
        ...
        <tr class="tablerowalt">
            ...
            <td>The user must fulfill certain requirements to keep the item usable.
                Example requirements can be eating twice as much per day, undergoing a quest, sacrificing valuables to the item,
        ...
        <tr class="tablerow">
            ...
            <td>The item works as expected but also has a side effect appropriate to the item's powers.
                Example side effects include changing the owner's hair color, lowering or raising the temperature around the item,
