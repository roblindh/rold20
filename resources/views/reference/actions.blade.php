...
<div class="space-y-6" x-data="{
    ...
    <div class="bg-slate-50 p-4 rounded-xl border border-slate-200 flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div class="flex items-center gap-3 w-full md:w-auto">
            <select x-model="category" @change="applyFilters()" class="bg-white border border-slate-300 rounded-lg px-3 py-2 text-sm text-slate-700 focus:outline-none focus:border-indigo-500">
            ...
            <button @click="search = ''; category = ''; applyFilters();" class="text-xs text-slate-500 hover:text-slate-800 underline">Reset</button>
        </div>
    </div>
