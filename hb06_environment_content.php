...
?>
    ...
    <p>
    See DMG 4E p67+ for unusual terrain features. Try to make some of them more generic, possibly looking at effects of certain extraplanar environments.
    </p>
    ...
    <p>
    The 3.5E DMG has a large number of example traps.
    </p>
    ...
    Low ML: Standard universe. FTL drives, artificial gravity, etc. are possible but expensive.<br />
